...
namespace gpt2cuda {
    ...
    private:
        ...
        StdVeci inputs_; // the input tokens for the current forward pass
        StdVeci targets_; // the target tokens for the current forward pass
        ...
        StdVecf dwte_; //(Vp,C)
        StdVecf dwpe_; //(maxT,C)

        StdVecf encoded_;//(B,T,C)
        StdVec<StdVecf> residual_;//(L,B,T,C)
        StdVecf lnf_;//(B,T,C)
        
        StdVecf lnf_means_;//(B,T)
        StdVecf lnf_rstds_;//(B,T)

        StdVecf lnf_gamma_;//(C)
        StdVecf lnf_beta_;//(C)

        StdVecf dlnf_gamma_;//(C)
        StdVecf dlnf_beta_;//(C)
        

        StdVecf logits_;//(B,T,Vp)

        StdVecf dlogits_;//(B,T,Vp)
        StdVecf dlnf_;//(B,T,C)
        StdVec<StdVecf> dresidual3_;//(L,B,T,C)
        StdVecf dencoded_;//(B,T,C)
    ...
    public:
        ...
        using VecBTC = StdVec<StdVec<StdVecf>>;
